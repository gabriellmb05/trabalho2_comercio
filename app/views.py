...
def get_similarity_pearson(user_a_id,user_b_id):
	"""Função responsável por calcular a similaridade entre dois usuários. Dado dois 2 id's de usuário a função retorna calcula	a 
...
def get_similarity_cosine(user_a_id,user_b_id):
    """Função responsável por calcular a similaridade entre dois usuários. Dado dois 2 id's de usuário a função retorna 
...
def get_similarity_cosine_item(movie1, movie2):
    """Função responsável por calcular a similaridade entre dois itens (Movie). Dado dois 2 objetos Movie a função retorna calcula 
...
def get_intersection_user(movie1, movie2):
    """Dado dois 2 objetos Movie a função retorna os 
